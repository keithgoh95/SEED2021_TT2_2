...
__VERSION__ = "20201211141757_05AEFD"

__module_path = os.path.abspath(os.path.dirname(__file__))

RewardsProgramService = saved_bundle.load_bento_service_class(__module_path)
...
__all__ = ['__version__', 'RewardsProgramService', 'load']
