...
setuptools.setup(
    name='RewardsProgramService',
    version='20201211141757_05AEFD',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - RewardsProgramService:20201211141757_05AEFD
...
REST API FOR RewardsProgramService""",
    ...
    package_data={
        'RewardsProgramService': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'RewardsProgramService=RewardsProgramService:cli',
        ],
    }
)
